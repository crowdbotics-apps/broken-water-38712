"""
Django settings for broken_water_38712 project.
...
ROOT_URLCONF = 'broken_water_38712.urls'
...
WSGI_APPLICATION = 'broken_water_38712.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_water_38712 API",
    "DESCRIPTION": "API documentation for broken_water_38712 App",
    "VERSION": "v1",
}
